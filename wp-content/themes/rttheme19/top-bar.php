...
if( ( has_action( "rt_topbar_left" ) || has_action( "rt_topbar_right" ) ) && $show_top_bar ):
...
?>
<div class="rt-top-bar<?php echo ( "fullwidth" == $topbar_width ) ? " fullwidth" : ""; ?>">
	<div class="top-bar-inner<?php echo ( "fullwidth" == $topbar_content_width ) ? " fullwidth" : ""; ?>">
		<div class="top-bar-left">
			<?php
			/**
			 * rt_topbar_left hook
			 * @hooked rt_topbar_left_sideber - 10
			 */
