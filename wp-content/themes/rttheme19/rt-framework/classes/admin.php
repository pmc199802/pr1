...
class RTThemeAdmin extends RTTheme{
	...
	function load_admin_scripts(){
		...
		$rt_variables=array( 
				"reset_theme" => esc_html__('Are you sure that you want reset the theme settings? ','rt_theme'),
				"delete_image" => esc_html__('Are you sure that you want remove this image? ','rt_theme'),
				"delete_font" => esc_html__('Are you sure that you want remove this font? ','rt_theme'),
